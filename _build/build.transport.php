...
$sources = array(
    ...
    'source_assets' => array(
        'components/minishop2/payment/paypal.php'
    ),
    'source_core' => array(
        'components/minishop2/custom/payment/lib/paypal/cacert.pem',
        'components/minishop2/custom/payment/paypal.class.php',
        'components/minishop2/lexicon/en/msp.paypal.inc.php',
        'components/minishop2/lexicon/ru/msp.paypal.inc.php'
    )
, 'docs' => $root . 'docs/'
);
